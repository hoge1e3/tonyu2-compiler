...
Tonyu.klass.define({
  ...
  decls: {"methods":{"main":{"nowait":false,"isMain":true,"vtype":{"params":[],"returnValue":null}}},"fields":{"player":{},"players":{},"debug":{}}}
});
Tonyu.klass.define({
  ...
  methods: function (__superClass) {
    return {
      ...
      expand :function _trc_CornerMCTSBot_expand(ctx,node) {
        ...
        node.subnodes=node.actions.map((function anonymous_832(a) {
          var q;
          var n;
      ...
      fiber$expand :function* _trc_CornerMCTSBot_f_expand(_thread,ctx,node) {
        ...
        _this.expcount++;
        s=yield* _this.fiber$getState(_thread, ctx, node);
...
Tonyu.klass.define({
    ...
    return {
      ...
      step :function _trc_GameMaster_step() {
        ...
        if (_this.state.nextIsEvent(_this.context)) {
          ...
          let action = _this.getBot(_this.state.player).play(_this.context,_this.state);
  ...
  decls: {"methods":{"main":{"nowait":false,"isMain":true,"vtype":{"params":[],"returnValue":null}},"onAppear":{"nowait":false,"isMain":false,"vtype":{"params":[],"returnValue":null}},"step":{"nowait":false,"isMain":false,"vtype":{"params":[],"returnValue":null}},"getBot":{"nowait":false,"isMain":false,"vtype":{"params":["Number"],"returnValue":null}},"gameover":{"nowait":false,"isMain":false,"vtype":{"params":[],"returnValue":null}},"run":{"nowait":false,"isMain":false,"vtype":{"params":[],"returnValue":null}}},"fields":{"state":{},"context":{}}}
});
Tonyu.klass.define({
  fullName: 'user.JinusiBot',
  shortName: 'JinusiBot',
  namespace: 'user',
  superclass: Tonyu.classes.user.Bot,
  includes: [],
  methods: function (__superClass) {
    return {
      main :function _trc_JinusiBot_main() {
        var _this=this;
        
      },
      fiber$main :function* _trc_JinusiBot_f_main(_thread) {
        var _this=this;
        //var _arguments=Tonyu.A(arguments);
        
        
      },
      play :function _trc_JinusiBot_play(ctx,s) {
        var _this=this;
        var acts;
        var a;
      ...
      fiber$play :function* _trc_JinusiBot_f_play(_thread,ctx,s) {
        var _this=this;
        //var _arguments=Tonyu.A(arguments);
        var acts;
        var a;
        ...
        a=yield* _this.fiber$spread(_thread, acts);
        
        return a;
        
      },
      searchCorner :function _trc_JinusiBot_searchCorner(stationArray) {
        var _this=this;
        var biggest;
        var i;
      ...
      fiber$searchCorner :function* _trc_JinusiBot_f_searchCorner(_thread,stationArray) {
        var _this=this;
        //var _arguments=Tonyu.A(arguments);
        var biggest;
        var i;
      ...
      spread :function _trc_JinusiBot_spread(acts) {
        var _this=this;
        
      },
      fiber$spread :function* _trc_JinusiBot_f_spread(_thread,acts) {
        var _this=this;
        //var _arguments=Tonyu.A(arguments);
        
        
      },
      spraying :function _trc_JinusiBot_spraying(acts) {
        var _this=this;
        var choice;
        var stn;
        var kouho;
      ...
      fiber$spraying :function* _trc_JinusiBot_f_spraying(_thread,acts) {
        var _this=this;
        //var _arguments=Tonyu.A(arguments);
        var choice;
        var stn;
      ...
      shuffle :function _trc_JinusiBot_shuffle(stArray) {
        var _this=this;
        var newArray;
        var choice;
        var z;
      ...
      fiber$shuffle :function* _trc_JinusiBot_f_shuffle(_thread,stArray) {
        var _this=this;
        //var _arguments=Tonyu.A(arguments);
        var newArray;
        var choice;
  ...
  decls: {"methods":{"main":{"nowait":false,"isMain":true,"vtype":{"params":[],"returnValue":null}},"play":{"nowait":false,"isMain":false,"vtype":{"params":["user.Context","user.State"],"returnValue":"user.Action"}},"searchCorner":{"nowait":false,"isMain":false,"vtype":{"params":[null],"returnValue":null}},"spread":{"nowait":false,"isMain":false,"vtype":{"params":[null],"returnValue":null}},"spraying":{"nowait":false,"isMain":false,"vtype":{"params":[null],"returnValue":null}},"shuffle":{"nowait":false,"isMain":false,"vtype":{"params":[null],"returnValue":null}}},"fields":{}}
});
Tonyu.klass.define({
  ...
  methods: function (__superClass) {
    return {
      ...
      expand :function _trc_MCTSBot_expand(ctx,node) {
        ...
        node.subnodes=node.state.actionsEvents(ctx).map((function anonymous_683(a) {
      ...
      selection :function _trc_MCTSBot_selection(ctx,node) {
        ...
        while (true) {
          ...
          for (a = 0;
           a<acts.length ; a++) {
            {
              let qq = _this.q(node,a);
              
              qc = qq*sgn+_this.c(node,a);
      ...
      fiber$selection :function* _trc_MCTSBot_f_selection(_thread,ctx,node) {
        ...
        while (true) {
          ...
          for (a = 0;
           a<acts.length ; a++) {
            {
              let qq=yield* _this.fiber$q(_thread, node, a);
  ...
  decls: {"methods":{"main":{"nowait":false,"isMain":true,"vtype":{"params":[],"returnValue":null}},"expand":{"nowait":false,"isMain":false,"vtype":{"params":["user.Context",null],"returnValue":null}},"str":{"nowait":false,"isMain":false,"vtype":{"params":[null],"returnValue":null}},"c":{"nowait":false,"isMain":false,"vtype":{"params":[null,"Number"],"returnValue":null}},"q":{"nowait":false,"isMain":false,"vtype":{"params":[null,"Number"],"returnValue":null}},"n":{"nowait":false,"isMain":false,"vtype":{"params":[null,"Number"],"returnValue":null}},"selection":{"nowait":false,"isMain":false,"vtype":{"params":["user.Context",null],"returnValue":null}},"play":{"nowait":false,"isMain":false,"vtype":{"params":["user.Context","user.State"],"returnValue":"user.Action"}},"backup":{"nowait":false,"isMain":false,"vtype":{"params":[null,"Number"],"returnValue":null}},"rollout":{"nowait":false,"isMain":false,"vtype":{"params":[null,null,null],"returnValue":null}},"getState":{"nowait":false,"isMain":false,"vtype":{"params":[null,null],"returnValue":null}},"playRandom":{"nowait":false,"isMain":false,"vtype":{"params":["user.Context","user.State"],"returnValue":"user.Action"}},"nanc":{"nowait":false,"isMain":false,"vtype":{"params":[null],"returnValue":null}}},"fields":{"Cp":{},"expandThresh":{},"value":{},"iteration":{},"player":{},"timeout":{},"timeoutCount":{},"expcount":{}}}
});
Tonyu.klass.define({
  ...
  decls: {"methods":{"main":{"nowait":false,"isMain":true,"vtype":{"params":[],"returnValue":null}},"play":{"nowait":false,"isMain":false,"vtype":{"params":[null,"user.State"],"returnValue":"user.Action"}},"playN":{"nowait":false,"isMain":false,"vtype":{"params":[null,"user.State","Number"],"returnValue":null}}},"fields":{"n":{},"value":{}}}
});
Tonyu.klass.define({
...
Tonyu.klass.define({
  ...
  decls: {"methods":{"main":{"nowait":false,"isMain":true,"vtype":{"params":[],"returnValue":null}},"print":{"nowait":false,"isMain":false,"vtype":{"params":[null],"returnValue":null}},"next":{"nowait":false,"isMain":false,"vtype":{"params":["user.Context","user.Action"],"returnValue":"user.State"}},"actionsEvents":{"nowait":false,"isMain":false,"vtype":{"params":["user.Context"],"returnValue":null}},"gameover":{"nowait":false,"isMain":false,"vtype":{"params":["user.Context"],"returnValue":null}},"id":{"nowait":false,"isMain":false,"vtype":{"params":[null],"returnValue":null}},"playerIndex":{"nowait":false,"isMain":false,"vtype":{"params":[null,null],"returnValue":null}},"nextIsEvent":{"nowait":false,"isMain":false,"vtype":{"params":["user.Context"],"returnValue":null}}},"fields":{"player":{}}}
});
Tonyu.klass.define({
  fullName: 'user.Main',
  shortName: 'Main',
  ...
  methods: function (__superClass) {
    return {
      ...
      match :function _trc_Main_match() {
        ...
        _this.bots[1]=new Tonyu.classes.user.MCTSBot({Cp: 1,expandThresh: 3,value: Tonyu.bindFunc(_this,_this.value),totalTime: _this.tt1,timeout: _this.to1,iteration: _this.it1});
        _this.bots[2]=new Tonyu.classes.user.MCTSBot({Cp: 1,expandThresh: 3,value: Tonyu.bindFunc(_this,_this.value),totalTime: _this.tt2,timeout: _this.to2,iteration: _this.it2});
        ...
        mat.set(_this.floor(r/2),_this.floor(r/2),2);
        let player = 1;
        ...
        _this.logf.appendText(_this.tt1+","+_this.to1+","+_this.tt2+","+_this.to2+","+winner+"\n");
      },
  ...
  decls: {"methods":{"main":{"nowait":false,"isMain":true,"vtype":{"params":[],"returnValue":null}},"value":{"nowait":false,"isMain":false,"vtype":{"params":["user.Context","Number","user.Board"],"returnValue":null}},"match":{"nowait":false,"isMain":false,"vtype":{"params":[],"returnValue":null}}},"fields":{"bots":{},"logf":{},"its":{},"it1":{},"it2":{},"to1":{},"to2":{},"tt1":{},"tt2":{},"komas":{}}}
});
Tonyu.klass.define({
  fullName: 'user.Board',
  shortName: 'Board',
  ...
  methods: function (__superClass) {
    return {
      ...
      checkCon :function _trc_Board_checkCon(x,y,p) {
        var _this=this;
             ...
             vx<=1 ; vx++) {
              {
                ...
                if (_this.checkConDir(x,y,vx,vy,p)) {
                  return p;
                }
              }
            }
      ...
      fiber$checkCon :function* _trc_Board_f_checkCon(_thread,x,y,p) {
        var _this=this;
        //var _arguments=Tonyu.A(arguments);
      ...
      checkConDir :function _trc_Board_checkConDir(x,y,vx,vy,p) {
        var _this=this;
        
        for (let i = 0;
         i<5 ; i++) {
          {
            if (_this.mat.get(x,y)!=p) {
              return false;
            }
            x+=vx;
            y+=vy;
      ...
      fiber$checkConDir :function* _trc_Board_f_checkConDir(_thread,x,y,vx,vy,p) {
        var _this=this;
        //var _arguments=Tonyu.A(arguments);
  ...
  decls: {"methods":{"main":{"nowait":false,"isMain":true,"vtype":{"params":[],"returnValue":null}},"next":{"nowait":false,"isMain":false,"vtype":{"params":["user.Context",null],"returnValue":"user.State"}},"actionsEvents":{"nowait":false,"isMain":false,"vtype":{"params":["user.Context"],"returnValue":null}},"gameover":{"nowait":false,"isMain":false,"vtype":{"params":["user.Context"],"returnValue":null}},"checkCon":{"nowait":false,"isMain":false,"vtype":{"params":[null,null,null],"returnValue":null}},"checkConDir":{"nowait":false,"isMain":false,"vtype":{"params":[null,null,null,null,null],"returnValue":null}},"toString":{"nowait":false,"isMain":false,"vtype":{"params":[],"returnValue":null}}},"fields":{"mat":{},"player":{}}}
});
